...
public class SpinPaymentMethodsAdapter extends ArrayAdapter<PaymentMethod> {

    private Context context;
    private List<PaymentMethod> values;

    public SpinPaymentMethodsAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getPmName());
        return label;
    }
